                                    ...
                                    <div class="pt-0">
                                        ...
                                        @csrf
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <input class="form-control @error('email') is-invalid @enderror" type="email" id="email" name="email" required="" placeholder="Enter your email" value="{{ old('email') }}">
                                                @error('email')
                                                    <small class="text-danger">{{ $message }}</small>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <input class="form-control @error('password_confirmation') is-invalid @enderror" type="password" name="password_confirmation" required="" id="password_confirmation" placeholder="Confirm your password">
                                        ...
                                        <div class="text-center text-muted mb-4">
                                            <p class="mb-0">Do You have an account ?<a class='text-primary ms-2 fw-medium' href='{{ route('login') }}'>Sign in</a></p>
                                        </div>
