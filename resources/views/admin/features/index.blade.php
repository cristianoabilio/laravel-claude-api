                                    ...
                                    <div class="row"><div class="col-sm-12">
                                        <table id="datatable" class="table table-bordered dt-responsive table-responsive nowrap dataTable no-footer dtr-inline collapsed" aria-describedby="datatable_info" style="width: 1263px;">
                                            ...
                                            <tr>
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" style="width: 102px; display: none;" aria-label="Salary: activate to sort column ascending">Actions</th></tr>
                                            </thead>
                                            <tbody>
                                                @foreach ($features as $item)
                                                    <tr class="odd">
                                                        ...
                                                        <td><a href="{{ route('features.edit', $item->id) }}" class="btn btn-success">Edit</a></td>
                                                        <td><a href="{{ route('features.delete', $item->id) }}" id="delete" class="btn btn-danger">Delete</a></td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
