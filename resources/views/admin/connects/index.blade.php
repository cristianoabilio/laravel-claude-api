        ...
        <div class="container-xxl">
            <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
                <div class="flex-grow-1">
                    <h4 class="fs-18 fw-semibold m-0">Connects</h4>
                </div>
            </div>
                                            ...
                                            <tbody>
                                                @foreach ($connects as $item)
                                                    <tr class="odd">
                                                        ...
                                                        <td>
                                                            <a href="{{ route('connects.edit', $item->id) }}" class="btn btn-success">Edit</a>
                                                            <a href="{{ route('connects.destroy', $item->id) }}" id="delete" class="btn btn-danger">Delete</a>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
